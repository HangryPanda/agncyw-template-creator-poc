...
export function createWebsocketProviderWithDoc(id: string, doc: Doc): Provider {
  // Cast WebsocketProvider to Provider type - they have slightly different interfaces
  // In production, you'd want to properly wrap or adapt the WebsocketProvider
