...
export default function FullFeaturedToolbarPlugin(): JSX.Element {
    ...
    <div style={toolbarContainerStyle}>
      ...
      {showLinkInput && (
        <div style={linkInputContainerStyle}>
          <form onSubmit={handleLinkSubmit} style={linkFormStyle}>
            <input
              type="url"
              value={linkUrl}
              ...
              autoFocus
            />
            <button type="submit" style={linkSubmitButtonStyle}>
              Insert
            </button>
            <button
              type="button"
      ...
      {/* Tip */}
      <div style={tipStyle}>
        💡 <strong>Tip:</strong> Type <code>/</code> to open the command menu for quick inserts
      </div>
    </div>
  );
}
...
const linkSubmitButtonStyle: React.CSSProperties = {
  padding: '8px 16px',
...
const linkCancelButtonStyle: React.CSSProperties = {
  padding: '8px 16px',
